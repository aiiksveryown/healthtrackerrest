...
class UserDAOTest {
    ...
    private fun populateUserTable(): UserDAO{
    ...
    inner class ReadUsers {
        ...
        @Test
        fun `get user by email that exists, results in a correct user returned`() {
            transaction {
                ...
                //Act & Assert
                assertEquals(user1, userDAO.findByEmail(user1.email))
            }
        }
    }
